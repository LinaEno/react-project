...
function Toggle({ name, control, disabled }) {
  ...
  return (
    <StyledContainer>
      <StyledLabel color={!isActive ? RED_LABEL_COLOR : DEFAULT_LABEL_COLOR}>Income</StyledLabel>
      ...
      <StyledLabel color={isActive ? GREEN_LABEL_COLOR : DEFAULT_LABEL_COLOR}>Expense</StyledLabel>
    </StyledContainer>
  );
}
